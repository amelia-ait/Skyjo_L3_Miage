...
class CardTest {
    ...
    void cardsToString() {
        {
            Card card = new Card( CardValue.ACE);
            assertEquals("1C", card.toString());
        }
        {
            Card card = new Card( CardValue.TEN);
   ...
   /*  void getColor() {
    ...
    void stringToCards() {
        ...
        assertEquals(new Card( CardValue.TEN), cards[0]);
        assertEquals(new Card( CardValue.KING), cards[1]);
    }
